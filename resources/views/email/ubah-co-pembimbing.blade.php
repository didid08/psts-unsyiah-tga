...
<p>
	...
	Nama&nbsp;:&nbsp;&nbsp;{{ $nama }}<br>
	NIM&nbsp;&nbsp;:&nbsp;&nbsp;{{ $nim }}<br><br>
	Apabila setuju, anda dapat klik <a href="{{ route('terima-usul', ['name' => 'co-pembimbing-ubah', 'nim' => $nim, 'key' => $key]) }}">setuju</a>. Jika anda tidak setuju anda dapat klik <a href="{{ route('tolak-usul', ['name' => 'co-pembimbing-ubah', 'nim' => $nim, 'key' => $key]) }}">tidak setuju</a>.
