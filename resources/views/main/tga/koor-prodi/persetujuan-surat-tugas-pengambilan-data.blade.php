				...
				<table class="table table-bordered table-striped" id="persetujuan-surat-tugas-pengambilan-data">
					<thead>
						<tr class="bg-green">
							...
							<th scope="col" class="align-middle text-center">Surat Tugas Pengambilan Data</th>
					...
					<tbody>
						...
						@foreach ($semua_mahasiswa as $index => $mahasiswa)
							...
							@endphp
							<tr>
								<form action="{{ route('main.tga.koor-prodi.persetujuan-stpd.process', ['nim' => $mahasiswa->user->nomor_induk, 'opsi' => 'accept']) }}" method="post" style="display: inline;">
									...
									<td class="align-middle text-center">
										...
										<a target="_blank" href="{{ route('main.file', ['filename' => $stpd->$mhsId->content]) }}" class="text-green">Periksa</a>
									</td>
									<td class="align-middle text-center">
										@csrf
								...
								<td class="align-middle text-center">
									<form action="{{ route('main.tga.koor-prodi.persetujuan-stpd.process', ['nim' => $mahasiswa->user->nomor_induk, 'opsi' => 'decline']) }}" method="post" style="display: inline;">
										@csrf
