		...
		<tr>
			...
			<td class="text-center align-middle">
				...
				@else
					...
					@else
						<div class="custom-file">
							<input type="file" class="custom-file-input" name="kelengkapan-dokumen-yudisium-dan-wisuda" id="kelengkapan-dokumen-yudisium-dan-wisuda" onchange="showSelectedFile('#kelengkapan-dokumen-yudisium-dan-wisuda-label', event)" accept="application/zip" {!! in_array($disposisi->progress, range(34,36)) ? '' : 'disabled="disabled"' !!}>
