...
@section('custom-script')
	<script>
		$("#usulan-pengesahan-seminar-proposal").dataTable();
	</script>
@endsection
	...
	<div class="container">
		<div class="card">
			<div class="card-body" style="overflow-x: auto;">
				<table class="table table-bordered table-striped" id="usulan-pengesahan-seminar-proposal">
					<thead>
						<tr class="bg-green">
					...
					<tbody>
						...
						@foreach ($semua_mahasiswa as $index => $mahasiswa)
							...
							@endphp
							<tr>
								<form action="{{ route('main.tga.admin.usulan-pengesahan-sempro.process', ['nim' => $mahasiswa->user->nomor_induk, 'opsi' => 'accept']) }}" method="post" style="display: inline;">
								...
								<td class="align-middle text-center">
									<form action="{{ route('main.tga.admin.usulan-pengesahan-sempro.process', ['nim' => $mahasiswa->user->nomor_induk, 'opsi' => 'decline']) }}" method="post" style="display: inline;">
										@csrf
