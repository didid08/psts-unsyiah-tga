				...
				<table class="table table-bordered table-striped" id="usulan-pengesahan-sidang">
					...
					<tbody>
						...
						@foreach ($semua_mahasiswa as $index => $mahasiswa)
							...
							@endphp
							<tr>
								<form action="{{ route('main.tga.admin.usulan-pengesahan-sidang.process', ['nim' => $mahasiswa->user->nomor_induk, 'opsi' => 'accept']) }}" method="post" style="display: inline;">
								...
								<td class="align-middle text-center">
									<form action="{{ route('main.tga.admin.usulan-pengesahan-sidang.process', ['nim' => $mahasiswa->user->nomor_induk, 'opsi' => 'decline']) }}" method="post" style="display: inline;">
										@csrf
