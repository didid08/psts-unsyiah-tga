	...
	<tbody>
		<tr>
			...
			<td class="text-center align-middle">
				...
				@else
					@if (in_array($administrasi_tga->value('progress'), range(29,30)) && $administrasi_tga->value('repeat') == false)
		...
		@elseif (in_array($administrasi_tga->value('progress'), range(29,30)) && $administrasi_tga->value('repeat'))
			<tr>
				<td></td>
				<td></td>
				<td class="text-right align-middle">
