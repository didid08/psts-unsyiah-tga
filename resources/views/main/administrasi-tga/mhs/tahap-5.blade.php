	...
	<tbody>
		<tr>
			...
			<td class="text-center align-middle">
				...
				@else
					@if (in_array($administrasi_tga->value('progress'), range(9,10)) && $administrasi_tga->value('repeat') == false)
		...
		@elseif (in_array($administrasi_tga->value('progress'), range(9, 10)) && $administrasi_tga->value('repeat'))
			<tr>
				<td colspan="2"></td>
				<td class="text-center align-middle">
