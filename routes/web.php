...
Route::middleware(['auth'])->group(function () {
	...
	Route::get('/main/file/{filename}', 'Main\FileGetController')->name('main.file');
		...
		Route::middleware('only.ketua-kel-keahlian')->group(function () {
			...
			Route::post('/main/tga/ketua-kel-keahlian/pengubahan-pembimbing-co/process/{nim}', 'Main\TGA\KetuaKelKeahlian\PengubahanPembimbingController@process')->name('main.tga.ketua-kel-keahlian.pengubahan-pembimbing.process');
			Route::post('/ubah/pembimbing-co/{nim}', 'Main\TGA\KetuaKelKeahlian\PengubahanPembimbingController@ubah')->name('ubah.pembimbing-co');
		});
